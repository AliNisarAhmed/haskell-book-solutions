...
/* package test-proj-0.1.0.0 */
#ifndef VERSION_test_proj
#define VERSION_test_proj "0.1.0.0"
#endif /* VERSION_test_proj */
#ifndef MIN_VERSION_test_proj
#define MIN_VERSION_test_proj(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_test_proj */
...
#define CURRENT_COMPONENT_ID "test-proj-0.1.0.0-DYn7qurPoTe6V5R9X2qMIg-test-proj"
